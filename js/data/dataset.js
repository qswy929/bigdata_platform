var dataset = [
                {title:"IJCAI-17 口碑商家客流量预测",information:"口碑致力于为每个商家提供销售预测。基于预测结果，商家可以优化运营，降低成本，并改善用户体验。这次比赛中，我们将以恰当定义的销售预测问题为题。 我们鼓励创新的解法，帮助口碑成为更加智能的商业平台，更好地服务社会。同时，希望每位参赛选手都能享受到这次比赛带来的乐趣。",link:"dataset/detail.html"},
                ...
                {title:"数据集名称",information:"数据集的简要说明",link:"#"},
                {title:"数据集名称",information:"数据集的简要说明",link:"#"},
                {title:"数据集名称",information:"数据集的简要说明",link:"#"},
                {title:"数据集名称",information:"数据集的简要说明",link:"#"},
                {title:"数据集名称",information:"数据集的简要说明",link:"#"},
